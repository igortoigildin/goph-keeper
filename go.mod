module github.com/igortoigildin/goph-keeper
...
require (
	...
	github.com/ClickHouse/clickhouse-go/v2 v2.30.2 // indirect
	...
	github.com/ydb-platform/ydb-go-sdk/v3 v3.99.2 // indirect
